...
# run test file
b_stdout, b_stderr, b_exitcode = runcmdsafe(f"cd ../..; racket test.rkt -j -m interp-stackprog -g goldens/interp-large-1.gld -i input-streams/1.in stackprogs/large.sp")
