...
# run test file
b_stdout, b_stderr, b_exitcode = runcmdsafe(f"cd ../..; racket test.rkt -j -m interp-stackprog -g goldens/interp-sub-order-and-neg-2.gld -i input-streams/2.in stackprogs/sub-order-and-neg.sp")
