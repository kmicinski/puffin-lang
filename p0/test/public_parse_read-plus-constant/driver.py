...
# run test file
b_stdout, b_stderr, b_exitcode = runcmdsafe(f"cd ../..; racket test.rkt -j -m parse-stackprog -g goldens/parse-read-plus-constant.gld stackprogs/read-plus-constant.sp")
