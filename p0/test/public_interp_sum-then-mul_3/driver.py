...
# run test file
b_stdout, b_stderr, b_exitcode = runcmdsafe(f"cd ../..; racket test.rkt -j -m interp-stackprog -g goldens/interp-sum-then-mul-3.gld -i input-streams/3.in stackprogs/sum-then-mul.sp")
