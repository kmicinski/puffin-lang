...
# run test file
b_stdout, b_stderr, b_exitcode = runcmdsafe(f"cd ../..; racket test.rkt -j -m parse-stackprog -g goldens/parse-sub-order-and-neg.gld stackprogs/sub-order-and-neg.sp")
