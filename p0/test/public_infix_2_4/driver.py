...
# run test file
b_stdout, b_stderr, b_exitcode = runcmdsafe(f"cd ../..; racket test.rkt -j -m translate-infix -g goldens/infix-interp-2-4.gld -i input-streams/4.in infix-programs/2.infix")
