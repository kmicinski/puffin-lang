...
# run test file
b_stdout, b_stderr, b_exitcode = runcmdsafe(f"cd ../..; racket test.rkt -j -m translate-infix -g goldens/infix-interp-2-3.gld -i input-streams/3.in infix-programs/2.infix")
