...
# run test file
b_stdout, b_stderr, b_exitcode = runcmdsafe(f"cd ../..; racket test.rkt -j -m interp-stackprog -g goldens/interp-large-4.gld -i input-streams/4.in stackprogs/large.sp")
