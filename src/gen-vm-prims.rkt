...
(printf "// GENERATED by src/gen-vm-prims.rkt from src/stdlib.rkt -- do not edit.\n")
(printf "// Prim ids are manifest-list indices; the bytecode backend\n")
(printf "// (src/backend-bytecode.rkt) computes them from the same list.\n\n")
